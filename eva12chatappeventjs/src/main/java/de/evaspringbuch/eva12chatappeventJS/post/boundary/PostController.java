package de.evaspringbuch.eva12chatappeventJS.post.boundary;
...
import de.evaspringbuch.eva12chatappeventJS.post.service.PostService;
...
public class PostController {
    ...
    public String listAllPosts2(@RequestParam String to, Model model) {
        String from = CurrentUserUtil.getCurrentUser(model);
        List<PostDTO> list = postService.listAllPostsFromTo(from, to);
        model.addAttribute("listAllPosts", list);
        model.addAttribute("toUser", to);
        return "partOfPosting";
    }
